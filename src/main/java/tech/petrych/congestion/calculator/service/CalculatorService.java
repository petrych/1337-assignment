...
public class CongestionTaxCalculatorService {
	...
	public int getTax(IVehicle vehicle, Date[] dates) {
	...
	private boolean isTollFreeVehicle(IVehicle vehicle) {
	...
	public int getTollFee(Date date, IVehicle vehicle) {
	...
	private Boolean isTollFreeDate(Date date) {
		...
		if (year == 2013) {
			if ((month == 1 && dayOfMonth == 1) ||
					...
					(month == 5 && (dayOfMonth == 1 || dayOfMonth == 9)) ||
					(month == 6 && (dayOfMonth == 6 || dayOfMonth == 21)) ||
					(month == 7) ||
